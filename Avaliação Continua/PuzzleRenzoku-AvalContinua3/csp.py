...
changed by Sara C. Madeira - FCUL Sistemas Inteligentes 2006/17"""
...
class CSP(search.Problem):
    ...
    def nconflicts(self, var, val, assignment):
        "Return the number of conflicts var=val has with other variables in assignment."
    ...
    # we need actions, result and goal_test
    # a state is a tuple of duples: (var,val)
    # an action is a duple: (var,val)
