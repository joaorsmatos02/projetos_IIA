...
# Jogador aleatorio
def aleatorio_15(estado, jogador):
    return randrange(1,100)

# Belarmino
def belarmino_15(estado, jogador):
    s = 0
    if jogador == 1:
        pieces = estado.white
    else:
...
# segue estrategia semelhante ao belarmino mas retira pontos se o oponente estiver
# perto de ganhar
def eder_15(estado, jogador):
    s = 0
    if jogador == 1:
...
# se puder ganhar na proxima jogada vai faze-lo sempre
def ruiPatricio_15(estado, jogador):
    s = 0
    if jogador == 1:
        ourPieces = estado.white
        otherPieces = estado.black
...
# evita mover peças para posicoes onde possam ser eliminadas na prox jogada
def pepe_15(estado, jogador):
    alphabet = "abcdefgh"
    s = 0
    if jogador == 1:
        ourPieces = estado.white
    ...
    for key in ourPieces:
        if jogador == 1: # se for peças brancas
            ...
            # se puder ser comida na proxima, retirar pontos
